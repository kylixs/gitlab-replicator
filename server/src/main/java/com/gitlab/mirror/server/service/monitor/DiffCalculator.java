    ...
    private List<BranchComparison> compareBranchSnapshots(
        ...
        for (String branchName : allBranchNames) {
            ...
            BranchComparison comparison = BranchComparison.builder()
                ...
                .sourceCommitAuthor(sourceSnapshot != null ? sourceSnapshot.getCommitAuthor() : null)
                .targetCommitAuthor(targetSnapshot != null ? targetSnapshot.getCommitAuthor() : null)
                .sourceCommitMessage(sourceSnapshot != null ? sourceSnapshot.getCommitMessage() : null)
                .targetCommitMessage(targetSnapshot != null ? targetSnapshot.getCommitMessage() : null)
